    ...
    <div className='flex flex-col gap-2 flex-wrap'>
      ...
      <div className='flex gap-2'>
        {Array.from(Array(max).keys()).map((starRating) => (
          <button
            key={'start-rating-' + starRating + 1}
            onClick={() =>
              starRating + 1 === selectedRating ? handleSelectedRating(0) : handleSelectedRating(starRating + 1)
            }
          >
            <svg
              height='1.5rem'
            ...
            >
              <path
                style={{ fill: selectedRating >= starRating + 1 ? 'yellow' : 'gray' }}
