...
export class FindProductByIdService {
  ...
  constructor(productDbRepository: ProductsDbRepository, validator: IValidator<{ id: string }>) {
    (this.productDbRepository = productDbRepository), (this.validator = validator);
  }
