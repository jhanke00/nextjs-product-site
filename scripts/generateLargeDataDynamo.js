...
// Write to files
fs.writeFileSync('src/mock/large/products-dynamodb.json', pJSON);
console.log('DynamoDB Products Generated!');

fs.writeFileSync('src/mock/large/users-dynamodb.json', uJSON);
console.log('Users Generated!');

fs.writeFileSync('src/mock/large/orders-dynamodb.json', oJSON);
