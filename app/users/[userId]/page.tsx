...
import OrdersList from '@/src/utils/orders';
          ...
          <>
            <div>
              <div className='flex flex-1 flex-row justify-around'>
                <h2 className="text-right flex flex-1 flex-col p-4" style={{ paddingLeft: "10%" }}>Total Order</h2>
                <div className='text-right flex flex-1 flex-col font-semibold'>
                  <p className='font-semibold'>Total Spent: {totalExpense}</p>
                </div>
              </div>
              <h3 className={`mb-3 text-xl `} style={{backgroundColor:'white'}}>
                {
